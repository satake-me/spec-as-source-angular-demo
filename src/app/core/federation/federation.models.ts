...
export const FEDERATION_REMOTE_NAMES = ['mf1', 'mf2', 'ocpi-mfe', 'payments-mfe'] as const;
...
export type RemoteComponentExportName = 'Mf1Component' | 'Mf2Component' | 'OcpiMfeComponent' | 'PaymentsMfeComponent';
